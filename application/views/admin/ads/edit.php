            ...
            <form id="formAddCatalog" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Giới thiệu ngắn
                        <span class="required">*</span></label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <textarea name="txtIntro" rows="4" class="form-control" ><?php echo str_replace('<br />', '&#13;', $ads->intro) ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Diện tích12<span class="required">*</span></label>
...
<!--                    <div class="col-md-8 col-sm-8 col-xs-12">-->
<!--                        <input type="text" id="txtDocumentTitle" name="txtDocumentTitle" value="--><?php //echo $ads->document_title ?><!--" required="required" class="form-control col-md-7 col-xs-12" placeholder="Tiêu đề tin trên web">-->
<!--                    </div>-->
<!--                </div>-->
