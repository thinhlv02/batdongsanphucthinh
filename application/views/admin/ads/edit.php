    ...
    <div class="x_content">
        ...
        <div class="row">
            <form id="formAddCatalog" data-parsley-validate class="form-horizontal form-label-left" method="post"
                ...
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Diện tích MB<span
                                class="required">*</span></label>
                ...
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Tên liên lạc<span
                                class="required">*</span></label>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="text" name="txtContactName" value="<?php echo $ads->contact_name; ?>"
                               class="form-control col-md-5 col-xs-12" placeholder="tên liên hệ">
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="text" name="phone"  value="<?php echo $ads->phone ?>"
                               class="form-control col-md-5 col-xs-12" placeholder="sđt liên hệ">
                    </div>
                </div>
...
//                                    echo $first[0]. '<br/>';
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10 col-sm-10 col-xs-12">
                        <input type="text" name="ads_link" value="<?php echo $ads->ads_link ?>" class="form-control col-md-7 col-xs-12" placeholder="nhập link bài viết">
                    </div>
                </div>
