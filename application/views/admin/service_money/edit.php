            ...
            <form id="formAddCatalog" data-parsley-validate class="form-horizontal form-label-left" method="post"
                ...
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">service_money
                        <span class="required">*</span></label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="number" name="service_money" id="service_money" value="<?php echo $ads->service_money ?>"
                               required="required" class="form-control col-md-7 col-xs-12" placeholder="service_money">
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">make_money_by
                        <span class="required">*</span></label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">TG nạp<span
                                class="required"></span></label>
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <input type="text" id="txtFrom" name="date" required
                               value="<?php echo $pay_time ?>"
...
<script>
    ...
    {
        $('#service_money').setMask({mask : '999,999,999,999,999,999,999,999,999,999,999,999,999,999,999,999,999,999,999,999,999,999,999,999,999', type : 'reverse', defaultValue: '0',textAlign:'false', textAlign: false});
    });
</script>