                    ...
                    <?php if($admin->id == 1) { ?>
                        <li><a><i class="fa fa-book"></i>Quản lý chung<span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                ...
                                <li><a href="<?php echo admin_url('service_money') ?>">Tiền KH chuyển khoản đẩy tin</a></li>
                                <li><a href="<?php echo admin_url('money_lost') ?>">Tiền tiêu hao</a></li>
<!--                                <li><a href="--><?php //echo admin_url('Upload_Files') ?><!--">Upload_Files</a></li>-->

                                <li><a href="<?php echo admin_url('product') ?>">Giới thiệu</a></li>
                                ...
                                <li><a href="<?php echo admin_url('ads_type') ?>">Quản lý loại nhà đất</a></li>
