        ...
        <div class="row" style="margin-top: 40px">
            <form id="formAddCatalog" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="txtDocumentTitle" name="txtDocumentTitle" value="<?php echo $devices->document_title?>" required="required" class="form-control col-md-7 col-xs-12" placeholder="Document Title">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="txtMetaDescription" name="txtMetaDescription" value="<?php echo $devices->meta_description?>" required="required" class="form-control col-md-7 col-xs-12" placeholder="Meta Description">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="txtMetaKeywords" name="txtMetaKeywords" value="<?php echo $devices->meta_keywords?>" required="required" class="form-control col-md-7 col-xs-12" placeholder="Meta Keywords">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="txtCanonicalUrl" name="txtCanonicalUrl" value="<?php echo $devices->canonical_url?>" required="required" class="form-control col-md-7 col-xs-12" placeholder="Canonical URL">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <label class="radio-inline"><input type="checkbox" name="robots_meta[]" value="noindex" <?php echo $devices->robots_meta && strpos($devices->robots_meta, 'noindex') > -1 ? 'checked' : '' ?> > Apply noindex to this page</label><br>
                        <label class="radio-inline"><input type="checkbox" name="robots_meta[]" value="nofollow" <?php echo $devices->robots_meta && strpos($devices->robots_meta, 'nofollow') > -1 ? 'checked' : '' ?> > Apply nofollow to this page</label><br>
                        <label class="radio-inline"><input type="checkbox" name="robots_meta[]" value="noarchive" <?php echo $devices->robots_meta && strpos($devices->robots_meta, 'noarchive') > -1 ? 'checked' : '' ?> > Apply noarchive to this page</label>
                    </div>
                </div>
