        ...
        <div class="row">
            <form id="formAddCatalog" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="" name="imei" class="form-control col-md-7 col-xs-12" placeholder="mã imei">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="number" id="" name="txtPrice" class="form-control col-md-7 col-xs-12" placeholder="Giá tiền">
                    </div>
                </div>
