...
<!--    switch language -->
    ...
    <ul class="ul-large">
        ...
        <li class="dropdown <?php echo !empty($li_9) ? 'menu-active' : ''?>" title="<?php echo $common_lang['lmenu_phonebook']; ?>">
            ...
            <div class="dropdown-content">
                ...
                <a href="javascript:void(0)"><?php echo $common_lang['lmenu_broker']; ?></a>
            </div>
        </li>
