    ...
    <div class="container">
        <div class="col-sm-12 col-md-12">
                            ...
                            <div class="item-news">
                                <div class="img-news" style="background-image: url(<?php echo public_url('images/news/'.$value->img)?>)">
                                    <div class="content-news">
                                        ...
                                        <a href="<?php echo base_url('tin-tuc/'.create_slug($value->title).'-'.$value->id)?>" class="btn btn-primary" style="margin-top: 10px">Xem thêm</a>
                                    </div>
            ...
            <div style="text-align: center">
                <a href="<?php echo base_url('rao-vat1.html')?>" class="btn btn-primary" style="margin-top: 20px">Xem thêm</a>
            </div>
        </div>
    </div>
</section>