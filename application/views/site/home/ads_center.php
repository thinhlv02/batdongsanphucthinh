    ...
    <div class="container">
        ...
        <div class="col-sm-12 col-md-12">
            ...
            <div class="row">
                ...
                <?php foreach ($ads_center

                as $key => $value) { ?>

                <div class="col-md-3 col-sm-6 col-xs-12 top2 item_ads _hot p-5"
                    ...
                    <div class="card mb-0">
                        <div class="card-body border-primary">
                            ...
                            <div class="row area gia-title">
                                <div class="col-xs-12 larea">DTMB: <strong><?php echo $value->acreage ?>
                                        m<sup>2</sup></strong></div>
                                <div class="col-xs-12 larea">DTSD:
                                    <strong><?php echo $value->useacreage != '' ? $value->useacreage : 0 ?>
                                        m<sup>2</sup></strong></div>
                            </div>
                            <div class="">
