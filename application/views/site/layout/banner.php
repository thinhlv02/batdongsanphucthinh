...
<!--            <p style="display: none" class="caption-banner animated slideInLeft">Đơn giản hoá việc bán hàng<br>vì chúng tôi luôn bên bạn-->
            <p style="" class="caption-banner animated slideInLeft">Đơn giản hoá việc bán hàng<br>vì chúng tôi luôn bên bạn
<!--            <p style="" class="caption-banner animated slideInLeft">Đơn giản hoá việc bán hàng , vì chúng tôi luôn bên bạn-->
            </p>
