...
Class MY_Controller extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->_product_type = $this->_func_product_type();
...
//                pre('abc');
            ...
            default:
            {
                ...
                $products = $this->introduce_model->get_list(array('order' => array('id', 'asc')));
...
//        $header['metaImage'] = isset($data['metaImage']) ? $data['metaImage'] : '';
    ...
    protected function _func_product_type()
    {
        return $this->config->config["product_type"];
    }
