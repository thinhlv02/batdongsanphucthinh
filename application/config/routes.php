...
$route['gioi-thieu(.html)?'] = 'home/service_info';
$route['gioi-thieu/(:any)-(:num)(.html)?'] = 'home/service_info/$1/$2';
...
$route['rao-vat-link/(:any)-(:num)(.html)?'] = 'home/product_detail_link/$1/$2';
